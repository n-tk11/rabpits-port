...
| ID | Task | Status | Branch | Notes |
|---|---|---|---|---|
| p1-schema | Full Prisma schema (all models, enums, relations) | todo | — | Depends on: Phase 0 |
| p1-seed | Dev seed script (portfolios + assets + transactions) | todo | — | Depends on: p1-schema |
